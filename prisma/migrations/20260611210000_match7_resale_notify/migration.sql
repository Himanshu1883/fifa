...
CREATE TABLE IF NOT EXISTS "resale_discord_match_notify_state" (
...
CREATE TABLE IF NOT EXISTS "resale_discord_match_notify_logs" (
    "id" SERIAL NOT NULL,
    "match_num" INTEGER NOT NULL,
...
CREATE INDEX IF NOT EXISTS "resale_discord_match_notify_logs_match_num_fingerprint_created_at_idx"
